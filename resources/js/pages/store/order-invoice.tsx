...
export default function OrderInvoice({ order }: { order: InvoiceOrder }) {
    const { t } = useLocale();
    const total = Number(order.total);

    return (
        <StoreLayout title={`Invoice #${order.order_number}`}>
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start">
                <Card className="flex-1">
                    ...
                    <CardContent className="space-y-6 text-sm">
                        <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                            <div>
                                <p className="font-semibold">{t('app_name')}</p>
                ...
                <div className="flex w-full justify-end md:w-auto md:px-2">
                    <Button
                        variant="outline"
                        className="border-neutral-300 bg-white/80 text-xs font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:bg-neutral-800"
