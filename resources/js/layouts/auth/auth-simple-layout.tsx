...
export default function AuthSimpleLayout({
    ...
    return (
        <div className="relative flex min-h-svh flex-col items-center justify-center gap-6 overflow-hidden bg-gradient-to-b from-amber-50/70 via-background to-background p-6 md:p-10 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
